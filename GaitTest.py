...
SERIAL_PORT = '/dev/tty.Bittle4E_SSP' # Example port, change if needed
BAUD_RATE = 115200
...
def run_timed_square_sequence(ser):
    ...
    print("STEP 3: Marker is UP, turning left for 2.12 seconds.")
    ser.write(MARKER_UP)
    turn_left_90_degrees(ser)
    ser.write(BALANCE) 
    time.sleep(1.5)    
